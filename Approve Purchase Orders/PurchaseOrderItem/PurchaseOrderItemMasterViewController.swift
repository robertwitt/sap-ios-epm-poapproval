//
// PurchaseOrderItemMasterViewController.swift
...
class PurchaseOrderItemMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "POId, POItemPos", value: "\(purchaseorderitem.poid!), \(purchaseorderitem.poItemPos!)")
        return cell
    }
